  ...
  grunt.initConfig({
    ...
    requirejs: {
      compile: {
        options: {
          baseUrl: './src/js/app/',
          mainConfigFile: './src/js/app/require.js',
    ...
    copy: {
      build: {
        files: [
          ...
          { src: 'bower_components/curl/dist/curl/curl.js', dest: 'build/assets/js/curl.js' },
